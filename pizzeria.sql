...
--
-- Servidor: localhost
-- Tiempo de generación: 24-09-2026 a las 22:46:51
...
INSERT INTO `ingredientes` (`id`, `nombre`, `stock_disponible`, `costo`, `tipo`, `dias_maduracion`, `artesanal`, `tipo_carne`, `porcentaje_grasa`, `intensidad_sabor`, `tiempo_fermentacion`, `es_integral`) VALUES
(1, 'Muzzarella', 0, 2500, 'QUESO', 15, 1, NULL, NULL, 1, NULL, NULL),
(2, 'Parmesano', 9, 4500, 'QUESO', 30, 0, NULL, NULL, 5, NULL, NULL),
(3, 'Jamon', 8, 3100, 'CARNE', NULL, NULL, 'Cerdo', 9.12, NULL, NULL, NULL),
(4, 'Pepperoni', 9, 3800, 'CARNE', NULL, NULL, 'Vacuno/Cerdo', 31, NULL, NULL, NULL),
(5, 'Masa tradicional', 9, 800, 'MASA', NULL, NULL, NULL, NULL, NULL, 24, 0),
(6, 'Masa integral', 9, 1000, 'MASA', NULL, NULL, NULL, NULL, NULL, 48, 1),
(7, 'Salsa de tomate', 9, 1200, 'OTRO', NULL, NULL, NULL, NULL, 2, NULL, NULL);
